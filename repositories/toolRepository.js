/**
 * toolRepository.js
 * Responsabilidad: único punto de acceso a data/tools.json.
...
/**
 * Lee y parsea todos los registros de herramientas del archivo JSON.
 *
 * @returns {Object[]} Lista de registros de herramientas (puede ser vacía).
 */
const findAll = () => {
  try {
